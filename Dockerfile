...
# SPDX-FileCopyrightText: 2026 The updater-gradle Authors
...
LABEL org.opencontainers.image.title="semrel-plugin-updater-gradle" \
      org.opencontainers.image.description="semrel plugin: updater-gradle" \
      org.opencontainers.image.url="https://semrel.io" \
      org.opencontainers.image.source="https://github.com/SemRels/updater-gradle" \
